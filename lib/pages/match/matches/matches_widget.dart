                    ...
                    children: [
                        ...
                        onPressed: () async {
                          setState(() {
                            _model.selectedDate = functions
                                .decreasedSelectedDate(_model.selectedDate!);
                          });
                        },
                        text: '',
                        icon: Icon(
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          setState(() {
                            _model.selectedDate = functions
                                .increasedSelectedDate(_model.selectedDate!);
                          });
                        },
                        text: '',
                        icon: Icon(
                        ...
                        queryBuilder: (matchRecord) => matchRecord
                            .where(
                              ...
                              isLessThan: functions
                                  .upperSelectedDateTime(_model.selectedDate),
                            )
                            .where(
                              'match_start_time',
                              isGreaterThanOrEqualTo: functions
                                  .lowerSelectedDateTime(_model.selectedDate),
                            )
                      ...
                      builder: (context, snapshot) {
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, listViewIndex) {
                            ...
                            return Visibility(
                              visible: (listViewMatchRecord.matchStartTime! <
                                      functions.upperSelectedDateTime(
                                          _model.selectedDate)) &&
                                  (listViewMatchRecord.matchStartTime! >=
                                      functions.lowerSelectedDateTime(
                                          _model.selectedDate)),
                              child: InkWell(
                                ...
                                child: Container(
                                  ...
                                  child: Stack(
                                    children: [
                                      if (listViewMatchRecord.matchStatus != 0)
                                        Align(
                                          alignment:
