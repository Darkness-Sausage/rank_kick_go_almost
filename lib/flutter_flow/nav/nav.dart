...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'MatchDetail',
          path: '/matches/matchDetail',
          builder: (context, params) => MatchDetailWidget(
            matchID: params.getParam(
                'matchID', ParamType.DocumentReference, false, ['match']),
          ),
        ),
        FFRoute(
          name: 'History',
        ...
        FFRoute(
          name: 'Inmatch',
          path: '/matches/matchDetail/inmatch',
          builder: (context, params) => InmatchWidget(
            matchID: params.getParam(
                'matchID', ParamType.DocumentReference, false, ['match']),
          ),
        ),
        FFRoute(
          ...
          path: '/rankboard',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'Rankboard')
              : RankboardWidget(),
        ),
        FFRoute(
          name: 'EditAccount',
